...
app = FastAPI(title='Backstract Generated APIs - coll-ccbafa677947475f9c5e69198947b8d7', debug=False,
              docs_url='/admiring-mccarthy-21e23b48692711f09dbe56ef31aaacbe84/docs',
              openapi_url='/admiring-mccarthy-21e23b48692711f09dbe56ef31aaacbe84/openapi.json')
...
app.include_router(
    router,
    prefix='/admiring-mccarthy-21e23b48692711f09dbe56ef31aaacbe84/api',
    tags=['APIs v1']
)
